...
public class DCBExample extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(v -> {
            ...
            //lt
            File fileLT = new File(Environment.getExternalStorageDirectory(), "dcb_cfg/gen_blk_dcb.lcfg");

            try {
                ltApp.writeDeviceConfigurationBlockFromFile(fileLT);
            } catch (Exception e) {
                e.printStackTrace();
            }
            ltApp.readDeviceConfigurationBlock();
            ltApp.deleteDeviceConfigurationBlock();

            //pm
            File filePM = new File(Environment.getExternalStorageDirectory(), "dcb_cfg/lt_app_dcb.lcfg");

            try {
                pmApp.writeDeviceConfigurationBlockFromFile(filePM);
            } catch (IOException e) {
                e.printStackTrace();
            }
            pmApp.readDeviceConfigurationBlock();
            pmApp.deleteDeviceConfigurationBlock();
